...
from .views import SignInView, SignUpView, logout_view, profile_view, email_reset_view, avatar_reset_view

app_name = 'authentication'

urlpatterns = [
    path('email-reset', email_reset_view, name='email_reset'),
    path('avatar-reset', avatar_reset_view, name='avatar_reset'),
